...
//                "  primary key(id)\n" +
        ...
        mysqlSqlParser.sqltext = createDDL;
        ...
        TCreateTableSqlStatement createTable  = (TCreateTableSqlStatement)mysqlSqlParser.sqlstatements.get(0);

        System.out.println(createTable.getTableComment());
        System.out.println(createTable.getColumnList().getColumn(0));
        System.out.println(createTable.getTableName());
        System.out.println(createTable.getMySQLTableOptionList());
